...
├── 🤖 bot/                          # Telegram Bot
    - bot.py (implementado)
    handlers/
        - help_handeler.py (implementado)
        - message_handler.py (implementado)
        - start_handler.py (implementado)
        - summary_handler.py (implementado)
├── 🗃️ models/                       # Modelos de dados
    - base.py (implementado)
    - budget.py (implementado)
    - trasaction.py (implementado)
    - user.py (implementado)
├── 🔧 services/                     # Lógica de negócio
    - ai_processor.py (implementado)
    - database.py (implementado)
    - finance_calculator.py (implementado)
